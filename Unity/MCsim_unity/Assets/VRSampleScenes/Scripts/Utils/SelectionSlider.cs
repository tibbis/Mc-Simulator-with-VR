...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
		...
		public float selectionTime=1.5f; // seconds to select with head
		private float countTime=0f; // count down timer
		main mainScript; //Get main script
		...
		public CanvasRenderer gazeSelection; // user input reticle
		public CanvasRenderer gazeBackground;
        ...
        private void HandleOut ()
        {
			...
			gazeBackground.SetAlpha (0f);
            m_GazeOver = false;
			countTime = 0f; // reset counter
			gazeSelection.GetComponent<UnityEngine.UI.Image> ().fillAmount =0f; //clear fill circle
